...
public class EditEmail extends AppCompatActivity {
    EditText mEmail;
    TextView mFullName, mAge, mPhone;
    Button mRegisterBtn;
    FirebaseAuth fAuth;
            ...
            public void onClick(View v) {
                ...
                documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(EditEmail.this, "Success", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EditEmail.this, "Failure", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
