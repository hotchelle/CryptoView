...
public class EditPhone extends AppCompatActivity {
    EditText mPhone;
    TextView mFullName, mAge, mEmail;
    Button mRegisterBtn;
    FirebaseAuth fAuth;
            ...
            public void onClick(View v) {
                ...
                documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(EditPhone.this, "Success", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EditPhone.this, "Failure", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
